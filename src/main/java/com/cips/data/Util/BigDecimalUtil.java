...
public class BigDecimalUtil {
    ...
    public static BigDecimal div(double v1, double v2) {// v1 / v2
        BigDecimal b1 = new BigDecimal(Double.toString(v1));
        BigDecimal b2 = new BigDecimal(Double.toString(v2));
        // 应对除不尽的情况  2 = 保留小数点后两位   ROUND_HALF_UP = 四舍五入
        return b1.divide(b2, 2, BigDecimal.ROUND_HALF_UP);//return 返回字段信息

        /**参数字段*/
       // return b1.abs(b2, scale:2, BigDecimal.ROUND_HALF_UP);//return  返回字段信息
